...
> => {
  ...
  >(
    ({ id, content, name }) =>
      snippetOperations.updateSnippetById(id, content, name),
    {
      onSuccess,
    }
  );
...
export const useRunSnippet = () => {
  return useMutation<string[], Error, Snippet>((snippet) =>
    snippetOperations.runSnippet(snippet)
  );
};
...
export const useGetUsers = (
  ...
  return useQuery<PaginatedUsers, Error>(["users", name, page, pageSize], () =>
    snippetOperations.getUserFriends(snippetId, name, page, pageSize)
  );
};
...
export const useShareSnippet = () => {
  ...
  >(({ assetId, userId, userName }) =>
    snippetOperations.shareSnippet(assetId, userId, userName)
  );
};
...
export const usePostTestCase = () => {
  return useMutation<TestCase, Error, TestSnippetParams>((tc) =>
...
export const useTestSnippet = () => {
  return useMutation<TestCaseResult, Error, Partial<TestCase>>((tc) =>
    snippetOperations.testSnippet(tc)
  );
};

export const useGetFormatRules = () => {
  return useQuery<FormatRule[], Error>("formatRules", () =>
    snippetOperations.getFormatRules()
  );
};

export const useModifyFormatRules = ({
  onSuccess,
}: {
  onSuccess: () => void;
}) => {
...
export const useGetLintingRules = () => {
  return useQuery<LintRule[], Error>("lintingRules", () =>
    snippetOperations.getLintingRules()
  );
};

export const useModifyLintingRules = ({
  onSuccess,
}: {
  onSuccess: () => void;
}) => {
...
export const useFormatSnippet = () => {
  return useMutation<string, Error, Snippet>((snippetContent) =>
...
export const useGetFileTypes = () => {
  return useQuery<FileType[], Error>("fileTypes", () =>
